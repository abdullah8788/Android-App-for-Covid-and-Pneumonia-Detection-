...
public class SliderAdapter extends PagerAdapter {
    ...
    @Override
    public void destroyItem(@NonNull ViewGroup contianer,int position,@NonNull Object object){
        contianer.removeView((ConstraintLayout)object);
    }
}
